...
class GratisAchievements extends StatefulWidget {
  const GratisAchievements({
    super.key,
  ...
  @override
  State<GratisAchievements> createState() => _GratisAchievementsState();
}

class _GratisAchievementsState extends State<GratisAchievements> {
  String gratisLevel = "Level 1";
  int difficulty = 0;
  ...
  Future<void> getAchievements() async {
    ...
    if (snapshot.exists) {
      ...
      setState(() {
        gratisLevel = data!['gratisLevel'];
      });
      setLevel("Level $gratisLevel");
    }
  }
  ...
  //get hard tasks num
  Future<void> fetchUnpaidTasksCount() async {
    try {
      ...
      final unpaidTasksCount = querySnapshot.docs.length;

      // calculate difficulty (always 1–100)
      final newDifficulty =
          (unpaidTasksCount % 100 == 0 && unpaidTasksCount > 0)
              ? 100
              : (unpaidTasksCount % 100);
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: const Align(
            ...
            child: Text('Gratis Achievements',
                    ...
                    child: RichText(
                        ...
                        text: const TextSpan(
                            ...
                            children: [
                              ...
                              TextSpan(
                                text:
                                    "The metrics are simple, if you perform 100 unpaid tasks you get to the next level. Share of ",
                                style: TextStyle(
                                  fontSize: 10,
                                  color: Colors.white,
                                ),
                            ...
                            child: Container(
                                ...
                                child: Row(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(width: 3.w),
                                      Text(
                                          "${getLevelText(levels['Level 1']!)}/100 Unpaid\nTasks Performed",
                            ...
                            child: Container(
                                ...
                                child: Row(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(width: 3.w),
                                      Text(
                                          "${getLevelText(levels['Level 2']!)}/100 Unpaid\nTasks Performed",
                                          style: const TextStyle(
                                              fontSize: 10,
                                              color: Colors.white))
                                    ])),
                            ...
                            child: Container(
                                ...
                                child: Row(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(width: 2.w),
                                      Text(
                                          "${getLevelText(levels['Level 3']!)}/100 Unpaid\nTasks Performed",
                                          style: const TextStyle(
                                              fontSize: 10,
                                              color: Colors.white))
                                    ])),
                            ...
                            child: Container(
                                ...
                                child: Row(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(width: 3.w),
                                      Text(
                                          "${getLevelText(levels['Level 4']!)}/100 Unpaid\nTasks Performed",
                                          style: const TextStyle(
                                              fontSize: 10,
                                              color: Colors.white))
                                    ])),
                            ...
                            child: Container(
                                ...
                                child: Row(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(width: 3.w),
                                      Text(
                                          "${getLevelText(levels['Level 5']!)}/100 Unpaid\nTasks Performed",
                                          style: const TextStyle(
                                              fontSize: 10,
                                              color: Colors.white))
                                    ])),
                            ...
                            child: Container(
                                ...
                                child: Row(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(width: 3.w),
                                      Text(
                                          "${getLevelText(levels['Level 6']!)}/100 Unpaid\nTasks Performed",
                                          style: const TextStyle(
                                              fontSize: 10,
                                              color: Colors.white))
                                    ])),
                            ...
                            child: Container(
                                ...
                                child: Row(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(width: 3.w),
                                      Text(
                                          "${getLevelText(levels['Level 7']!)}/100 Unpaid\nTasks Performed",
                                          style: const TextStyle(
                                              fontSize: 10,
                                              color: Colors.white))
                                    ])),
                            ...
                            child: Container(
                                ...
                                child: Row(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(width: 3.w),
                                      Text(
                                          "${getLevelText(levels['Level 8']!)}/100 Unpaid\nTasks Performed",
                                          style: const TextStyle(
                                              fontSize: 10,
                                              color: Colors.white))
                                    ])),
                            ...
                            child: Container(
                                ...
                                child: Row(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(width: 3.w),
                                      Text(
                                          "${getLevelText(levels['Level 9']!)}/100 Unpaid\nTasks Performed",
                                          style: const TextStyle(
                                              fontSize: 10,
                                              color: Colors.white))
                                    ])),
                                        ...
                                        child: Container(
                                            ...
                                            child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  SizedBox(width: 1.w),
                                                  Text(
                                                      "${getLevelText(levels['Level 10']!)}/100 Unpaid\nTasks Performed",
                                                      style: const TextStyle(
                                                          fontSize: 10,
                                                          color: Colors.white))
                                                ])),
