...
class _TaskDetailsState extends State<TaskDetails> {
  Future<void> _launchURL() async {
    ...
    if (uri == null ||
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('This task does not have a valid external link.'),
          ),
        );
      }
      return;
    ...
    if (!await launchUrl(uri, mode: LaunchMode.externalApplication) &&
        mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Could not open the task link.')),
      );
    }
  }
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            Container(
                              width: widget.difficulty == 'Simple' ? 25.w : 30.w,
                            ...
                            IconButton(
                              onPressed: () => showReportTaskDialog(
                                context,
                                widget.uid,
                                widget.subtitle,
                              ),
              ...
              _card(
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 1.h),
                    Text(
                      widget.description.isEmpty ? 'None' : widget.description,
                      style: const TextStyle(color: Color(0xff6b7280)),
                    ),
                  ],
                ),
