...
class ApiClient {
  ...
  Future<Map<String, dynamic>> depositStatus(String reference) async => await _request('GET', '/wallet/deposits/${Uri.encodeComponent(reference)}') as Map<String, dynamic>;
  ...
  Future<List<dynamic>> activeGifts() async => await _request('GET', '/rewards/gifts') as List<dynamic>;
